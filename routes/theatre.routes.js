...
import { isAdmin, isAdminorClient, isAuthenticated } from '../middlewares/auth.middlewares.js';
const theatreRoutes = (app) => {
    ...
    app.patch('/mba/api/vi/theatres/:id/movies',isAuthenticated,isAdminorClient,validateUpdateMoviesRequest, updateMovies);
